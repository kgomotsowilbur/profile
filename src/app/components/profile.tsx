...
export default function Profile() {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center w-full h-full gap-4 xl:gap-0">
            <div ref={parallax.ref} className="spinner grid w-full place-items-center">
                <Image
                    alt=""
                    src={"/Grad.png"}
                    width={380}
                    height={600}
                    className="w-64 md:w-96 md:max-h-[70%] xl:h-auto xl:w-auto shadow-2xl shadow-purple-800 rounded-3xl"
                />
            </div>
            <div className="flex flex-col md:h-full w-fit md:justify-center gap-2 md:gap-4">
                ...
                <div className="flex flex-row w-full justify-center gap-4">   
                    <Link href="https://blak-shoppers.vercel.app" className="flex cursor-pointer">
                        <Parallax scale={[1, 0]} className="grid place-items-center rounded-full bg-purple-50/5 backdrop-blur-2xl hover:bg-purple-50/15 w-10 h-10 md:w-12 md:h-12">
                            <Image
                                src={"/blakicon.png"}
                                alt=""
                                width={300}
                    ...
                    <Link href="https://api.whatsapp.com/send?phone=27612967749" className="flex cursor-pointer">
                        <Parallax scale={[1, 0]} className="grid place-items-center rounded-full bg-purple-50/5 backdrop-blur-2xl hover:bg-purple-50/15 w-10 h-10 md:w-12 md:h-12">
                            <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-whatsapp fill-green-500 w-8 h-8 md:w-10 md:h-10" viewBox="0 0 16 16">
                    ...
                    <Link href="https://www.linkedin.com/in/kgomotso-manana-8787b1219" className="flex cursor-pointer">
                        <Parallax scale={[1, 0]} className="grid place-items-center rounded-full bg-purple-50/5 backdrop-blur-2xl hover:bg-purple-50/15 w-10 h-10 md:w-12 md:h-12">
                            <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-linkedin fill-blue-500 w-8 h-8 md:w-10 md:h-10" viewBox="0 0 16 16">
                    ...
                    <Link href="mailto:kgomotsowilbur@gmail.com" className="flex cursor-pointer">
                        <Parallax scale={[1, 0]} className="grid place-items-center rounded-full bg-purple-50/5 backdrop-blur-2xl hover:bg-purple-50/15 w-10 h-10 md:w-12 md:h-12">
                            <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-envelope-at fill-purple-50 w-8 h-8 md:w-10 md:h-10" viewBox="0 0 16 16">
